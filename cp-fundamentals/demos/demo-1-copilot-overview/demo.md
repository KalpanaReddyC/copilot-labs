...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Mode-Code%20Completions-000000?style=for-the-badge&logo=githubcopilot&logoColor=white" alt="Code Completions" />
...
The goal is to complete the 5 stubbed functions in `orders.py` using **Code completions** (inline suggestions) — no chat panel needed.
---
...
| Setting | Value |
|---|---|
| **Mode** | **Code completions** (inline suggestions; no chat panel needed) |
...
| Function | Delete this | Type this seed (and pause) | Code completion should produce |
|---|---|---|---|
...
> If the gray ghost text suggests a padded version, adjust it to use literal spaces.
